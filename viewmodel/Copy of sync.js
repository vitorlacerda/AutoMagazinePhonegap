...
var deactivator = function(event){ event.preventDefault(); return false;};
...
function initSync() {
    ...
    $('#page-sync :checkbox').click(deactivator);
}
            ...
            $.ajax({
                    ...
                    success: function (data) {
                        ...
                        app.db.transaction(function (tx) {
                            ...
                            //self.CreateAreaServico();
                            //alert("Sincronismo realizado com sucesso!");
                        });
